...
public:
	...
	{
		glm::vec3 forwards = glm::normalize(position - target);
		glm::vec3 right = glm::normalize(glm::cross(worldUp, forwards));
		...
		rotation[1][1] = up.y;
		rotation[2][1] = up.z;
		rotation[0][2] = forwards.x; // First column, third row
		rotation[1][2] = forwards.y;
		rotation[2][2] = forwards.z;
