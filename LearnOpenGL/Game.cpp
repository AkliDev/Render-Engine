...
void Game::Init()
{
	...
	ResourceManager::LoadShader("shaders/particle.vert", "shaders/particle.frag", nullptr, "particle");
 	ResourceManager::LoadShader("Shaders/texture.vert", "Shaders/texture.frag", nullptr, "postprocessing");
	ResourceManager::LoadShader("shaders/font.vert", "shaders/font.frag", nullptr, "text");
	...
	ResourceManager::LoadTexture("textures/particle.png", false, "particle");
	...
	Text->Load("fonts/zeldadxt.TTF", 24);
